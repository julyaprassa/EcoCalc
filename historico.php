...
$sql = "SELECT calculado_em, emissao_total FROM calculos WHERE usuario_id = ? ORDER BY calculado_em DESC";
...
<head>
  ...
  <title>Meu Histórico Real — EcoCalc</title>
</head>
          ...
          <?php else: ?>
            <?php foreach ($meus_calculos as $calc): ?>
              <div class="historicoitem" style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #eee; padding: 15px 0;">
                ...
                <a href="conta.php" class="botaohist" style="text-decoration:none;">
                  Ver detalhes
                </a>
              </div>
            <?php endforeach; ?>
